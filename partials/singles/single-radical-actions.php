...
<div class="dsroi-post dsroi-radical-actions">
  <?php while ( have_posts() ) : the_post(); ?>
    <article <?php post_class( 'entry' ); ?>>
        ...
        <div class="back-to-archive" style="margin-bottom:15px;"><i class="fa fa-long-arrow-left" aria-hidden="true"></i> <a href="/radical-action-archive/search/">Return to Archive</a></div>
